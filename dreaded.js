...
client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/cd931271ca262b184db48.jpg' }, caption: cap, fileLength: "9999999999"}, { quoted: m })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
...
let xf = m.quoted.text;
                ...
                let pppuser = await client.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/cd931271ca262b184db48.jpg)
...
await m.reply('𝐑𝐞𝐦𝐨𝐯𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐛𝐲 𝐁𝐞𝐞𝐭𝐥𝐞'); 
 ...
 client.sendMessage(m.chat, { image: { url: `https://telegra.ph/file/cd931271ca262b184db48.jpg` }, caption: 
